...
document = cv2.VideoCapture(0)
document.set(cv2.CAP_PROP_FRAME_WIDTH, 1200)
document.set(cv2.CAP_PROP_FRAME_HEIGHT, 720)
...
font = pygame.font.SysFont("malgungothicsemilight",32)
...
can_metni_koordinati.topright = (genislik-10,10)
